...
Source0  : https://github.com/ColinIanKing/pagemon/archive/refs/tags/V0.02.03.tar.gz
...
%prep
%setup -q -n pagemon-0.02.03
cd %{_builddir}/pagemon-0.02.03
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705059431
